    ...
    public:
        ...
        int solve_NMPC_PHR_AL(const VectorX &x0_observe)
        {
            ...
            // PHR-ALM
            {
                ...
                const double cons_eps = 1e-3, prec_eps = 1e-3;
                double cons_residual = 1e5, prec_residual = 1e5;
                ...
                auto Calculate_Optimal_Control_Sequence = [&]() -> void
                {
                    ...
                    lbfgs_params.line_search_type = 0;
                    double minObjective;
                    ret = lbfgs::lbfgs_optimize(m * N_, x, &minObjective, &ALObjectiveFunc, nullptr, nullptr, this, &lbfgs_params);
                ...
                {
                    // std::cout << "cons_residual: " << cons_residual << " "
                    //           << "prec_residual: " << prec_residual << std::endl;
